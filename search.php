...
<ul class="breadcrumb bc3x">
  ...
  <li><a href="javascript:void(0)"><?php echo $str ?></a></li>
       ...
       <div class="section2">  
         <div class="container" style="margin-top:30px" ;> 
          ...
          height:100%; border-width:thin;">  
             ...
             <div style="text-align:center;margin-top:5px;padding:10px;margin-bottom:5px;" class="wish"><a href="javascript:void(0)" onclick="manage_wishlist('<?php echo $list['id'] ?>','add')" class="btnx">+ Add to Wish List</a></div>
           </div>  
           <?php } ?>  
         </div>  
       </div> 
